        ...
        <div className="md:hidden">
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            <SheetTrigger asChild>
              <Button variant="ghost" size="icon" className="hover:bg-primary/50 focus-visible:bg-primary/50">
                <Menu className="h-6 w-6" />
                <span className="sr-only">Abrir menu</span>
              </Button>
            </SheetTrigger>
            <SheetContent side="right" className="w-[280px] bg-background text-foreground p-0">
                <div className="flex flex-col h-full">
                    ...
                    <div className="mt-auto p-4 border-t">
                        <Button asChild size="lg" className="w-full">
                            <Link href="/enviar-relato" onClick={() => setIsOpen(false)}>Enviar Relato</Link>
                        </Button>
                    </div>
                </div>
            </SheetContent>
